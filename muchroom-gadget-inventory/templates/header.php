...
<nav class="mgi-drawer" id="mgi-drawer">
    <div style="padding:0 16px 16px;border-bottom:1px solid rgba(0,0,0,0.06);margin-bottom:8px;">
        <span class="text-muted" style="font-size:12px;text-transform:uppercase;letter-spacing:0.5px;"><iconify-icon icon="solar:map-point-linear"></iconify-icon> <?php echo esc_html( $branch_name ); ?></span>
    </div>
    <ul class="mgi-drawer-links">
        <li><a href="<?php echo esc_url( home_url( $branch_prefix . '/home/' ) ); ?>" class="<?php echo 'home' === $current_page ? 'active' : ''; ?>"><iconify-icon icon="solar:home-2-linear"></iconify-icon> Home</a></li>
        <li><a href="<?php echo esc_url( home_url( $branch_prefix . '/take-order/' ) ); ?>" class="<?php echo 'take-order' === $current_page ? 'active' : ''; ?>"><iconify-icon icon="solar:document-text-linear"></iconify-icon> Take Order</a></li>
        <li><a href="<?php echo esc_url( home_url( $branch_prefix . '/sales/' ) ); ?>" class="<?php echo 'sales' === $current_page ? 'active' : ''; ?>"><iconify-icon icon="solar:wallet-money-linear"></iconify-icon> Sales</a></li>
        <li><a href="<?php echo esc_url( home_url( $branch_prefix . '/inventory/' ) ); ?>" class="<?php echo 'inventory' === $current_page ? 'active' : ''; ?>"><iconify-icon icon="solar:box-linear"></iconify-icon> Inventory</a></li>
        <li><a href="<?php echo esc_url( home_url( $branch_prefix . '/import/' ) ); ?>" class="<?php echo 'import' === $current_page ? 'active' : ''; ?>"><iconify-icon icon="solar:import-linear"></iconify-icon> Import</a></li>
        <li><a href="<?php echo esc_url( home_url( $branch_prefix . '/financial/' ) ); ?>" class="<?php echo 'financial' === $current_page ? 'active' : ''; ?>"><iconify-icon icon="solar:money-bag-linear"></iconify-icon> Financial</a></li>
        <li><a href="<?php echo esc_url( home_url( $branch_prefix . '/analytics/' ) ); ?>" class="<?php echo 'analytics' === $current_page ? 'active' : ''; ?>"><iconify-icon icon="solar:chart-2-linear"></iconify-icon> Analytics</a></li>
        <?php if ( MGI_Auth::is_admin() ) : ?>
        <li><a href="<?php echo esc_url( home_url( $branch_prefix . '/admin/' ) ); ?>" class="<?php echo 'admin' === $current_page ? 'active' : ''; ?>"><iconify-icon icon="solar:settings-linear"></iconify-icon> Admin</a></li>
        <?php endif; ?>
        <li style="border-top:1px solid rgba(0,0,0,0.06);margin-top:8px;padding-top:8px;">
            <a href="<?php echo esc_url( home_url( '/muchroom/' ) ); ?>"><iconify-icon icon="solar:buildings-linear"></iconify-icon> Switch Branch</a>
        </li>
    </ul>
</nav>
...
<nav class="mgi-nav">
    <div class="mgi-nav-inner">
        <a href="<?php echo esc_url( home_url( $branch_prefix . '/home/' ) ); ?>" class="mgi-nav-brand">
            <span>Muchroom</span>
            <span style="font-size:11px;color:var(--text-muted);font-weight:500;margin-left:4px;"><iconify-icon icon="solar:map-point-linear"></iconify-icon> <?php echo esc_html( ucfirst( $branch ) ); ?></span>
        </a>
